...
function Navbar() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-1/2 transform -translate-x-1/2 max-w-[90%] overflow-x-auto md:overflow-visible md:block">
        ...
        <div className="relative px-2 py-1 rounded-full border border-gray-200 shadow-xl overflow-hidden">
          ...
          <div className="relative flex gap-2 md:gap-4 text-[11px] md:text-[13px] overflow-x-auto whitespace-nowrap text-gray-600 backdrop-blur-md bg-white/70 rounded-full px-6 py-2">
